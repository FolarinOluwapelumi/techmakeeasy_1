...
const HeroSection = () => {
  return (
    <main className="flex flex-col-reverse lg:flex-row justify-between items-center bg-gradient-to-r from-blue-400 to-purple-700 min-h-[80vh] px-6 md:px-12 py-16 gap-8">
      {/* Content Section */}
